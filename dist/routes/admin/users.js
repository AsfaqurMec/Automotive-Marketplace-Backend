...
UsersRoute.put("/customer/:id", async (req, res) => {
    try {
        ...
        const { fullName, email, phone, password, role, isVerified, isBlocked } = req.body;
...
UsersRoute.put('/dealer/:id', async (req, res) => {
    try {
        ...
        const { companyName, fullName, contactPerson, email, phone, licenseExpiry, isVerified, address, } = req.body;
