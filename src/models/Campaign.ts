...
const CampaignSchema = new mongoose.Schema(
  {
    ...
    description: { // This matches 'campaignLevelDescription' from your newCampaignData
      type: String,
      trim: true,
    },
    dealerId: {
    ...
    dailyBudget: { // Renamed from 'budget' to match newCampaignData
      type: Number,
      required: true,
      min: 0,
    },
    ...
    targetLocations: { // Can be a comma-separated string or you might want to parse into an array
      type: String,
      trim: true,
      // required: true, // Add if it's always required
    },
    ...
    totalBudget: { // Added field
      type: Number,
      min: 0,
      // required: true, // Add if it's always required
    },
    googleAdsCampaignId: { // Renamed from googleCampaignId
      type: String,
      trim: true,
      default: null,
    },
    googleAdsAdGroupId: { // Added field
      type: String,
      trim: true,
      default: null,
    },
